...
List of exercises 2 - Exercise 3
No exemplo de mapa de texturas, tente inverter do mapa especular no fragment shader,
de modo que a madeira mostre highlight especular e as bordas de aço não.

Change in the 4.2.lighting_maps.fs file.
*/
